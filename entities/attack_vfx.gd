...
## strefy czy auree).
static func spawn(parent: Node, texture: Texture2D, global_pos: Vector2, duration: float = DEFAULT_DURATION, vfx_scale: float = DEFAULT_VFX_SCALE, rotation_rad: float = 0.0) -> void:
