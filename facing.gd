...
## kamery/w dół. "side" pokrywa LEWO wprost (tak wygenerowany plik — sylwetka
## faktycznie patrzy w lewo, sprawdzone wizualnie), PRAWO przez flip_h (jeden
## plik, dwa kierunki), więc każda poza z wariantami potrzebuje tylko 2 nowych
